...
function Confirmorder() {
  ...
  return (
    <>
      ...
      <div className="row d-flex justify-content-around order-con bg-danger">
        <div className="col-12 col-lg-8 mt-4 order-confirm">
            ...
            <Fragment key={item.product}>
              ...
              <div className="cart-item my-1">
                <div className="row">
                  ...
                  <div className="col-4 col-sm-4 col-md-4 col-lg-4 mt-4 mt-lg-0">
                    <p>
